...
typedef NS_OPTIONS(NSUInteger, YYEncodingType) {
    ...
    YYEncodingTypeVoid       = 1,  ///< `v` void
    YYEncodingTypeBool       = 2,  ///< `B` bool
    YYEncodingTypeInt8       = 3,  ///< `c` char / BOOL
    YYEncodingTypeUInt8      = 4,  ///< `C` unsigned char
    YYEncodingTypeInt16      = 5,  ///< `s` short
    YYEncodingTypeUInt16     = 6,  ///< `S` unsigned short
    YYEncodingTypeInt32      = 7,  ///< `i` int
    YYEncodingTypeLong       = 24, ///< `l` long
    YYEncodingTypeUInt32     = 8,  ///< `I` unsigned int
    YYEncodingTypeULong      = 25, ///< `L` long
    YYEncodingTypeInt64      = 9,  ///< `q` long long
    YYEncodingTypeUInt64     = 10, ///< `Q` unsigned long long
    YYEncodingTypeFloat      = 11, ///< `f` float
    YYEncodingTypeDouble     = 12, ///< `d` double
    YYEncodingTypeLongDouble = 13, ///< `D` long double
